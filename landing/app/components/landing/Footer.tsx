    ...
    <footer className="border-t border-zinc-200/60 pt-12 pb-8">
      <div>
        ...
        <div className="grid grid-cols-3 gap-6 mb-10">
          <div>
            <h4 className="font-semibold text-xs uppercase tracking-wider text-zinc-400 mb-4">{t("product")}</h4>
            <ul className="space-y-2.5 text-sm text-zinc-600">
              <li><Link href={`/${lang}/docs/introduction`} className="hover:text-[#25D366] transition-colors">{t("docs")}</Link></li>
              <li><Link href={`/${lang}/docs/getting-started`} className="hover:text-[#25D366] transition-colors">{t("quickStart")}</Link></li>
              <li><Link href={`/${lang}/docs/concepts/plugins`} className="hover:text-[#25D366] transition-colors">{t("plugins")}</Link></li>
            </ul>
          </div>

          <div>
            <h4 className="font-semibold text-xs uppercase tracking-wider text-zinc-400 mb-4">{t("community")}</h4>
            <ul className="space-y-2.5 text-sm text-zinc-600">
