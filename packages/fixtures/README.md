...
Includes Meta ES v4 coexistence history sync fixtures, `smb_app_state_sync` contact updates, `smb_message_echoes`, account lifecycle events, unknown phone routing, and malformed payload edge cases.
